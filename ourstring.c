 ...
 * @s: the string whose length is to be evaluated
 *
...
/**
 * _strcmp - lexicogarphic comparison of two strangs is performed.
...
/**
 * begins_with - checks if needle is beginning with haystack
 * @haystack: search string
 * @needle: the substring to discover
 *
